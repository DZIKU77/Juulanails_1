...
function Hero() {
    return (
        <section className="h-screen pt-35" id="home">
            {/* Obrazki w tle */}
            ...
            <div className="text-center -mb-120">
                ...
                <h1 className="uppercase text-black text-9xl -mt-5 tracking-widest">paznokci</h1>
            </div>
            
            {/* Serce */}
            <div className="flex justify-center content-center -mb-130">
                <img src={hero_heart} alt="Serce" />
            </div>
            
            {/* Podtytuł */}
            <h2 className="font-['Dynalight',fantasy] text-center text-7xl ml-10">Piękno w twoich dłoniach</h2>
            
            {/* Sekcja z 3 Sektorami (Wszystkie divy teraz zamykają się poprawnie) */}
            ...
            </div> {/* <--- Tutaj zamyka się główny kontener sektorów */}
        </section>
    );
}
